...
function somdn_woo_quickview_settings_section_callback() { ?>
	<p><?php _e( 'Enable the Quick View feature for shop listing pages. Quick View will apply to all products.', 'download-now-for-woocommerce' ); ?> </p>
	<p><?php _e( 'Quick View allows users to preview a product without going to the product page, by clicking a "Quick View" button when hovering their mouse over a product in the shop.', 'download-now-for-woocommerce' ); ?></p>
	<p class="description"><?php _e( 'Note: This feature is currently in beta. Please report any issues you find.', 'download-now-for-woocommerce' ); ?></p><br>
<?php }
...
function somdn_woo_quickview_settings() {
	...
	add_settings_section(
		...
		__( 'WooCommerce Quick View Settings', 'download-now-for-woocommerce' ),
	...
	add_settings_field(
		...
		__( 'Enable Quick View', 'download-now-for-woocommerce' ),
	...
	if ( ! empty( $quickview_enabled ) ) {
		...
		add_settings_field(
			...
			__( 'Button Settings', 'download-now-for-woocommerce' ),
...
function somdn_woo_quickview_enable_render() {
	...
	<?php if ( ! $value ) { ?>
		<p class="description"><?php _e( 'Note: When enabled you will be able to customise this feature.', 'download-now-for-woocommerce' ); ?></p>
	<?php } ?>
