...
function somdn_settings_init() { 
	...
	add_settings_field(
		...
		__( 'Download Counts', 'download-now-for-woocommerce' ),
	...
	add_settings_field(
		'somdn_button_class',
		__( 'Button classes', 'download-now-for-woocommerce' ),
	...
	add_settings_field(
		'somdn_button_css',
		__( 'Button CSS', 'download-now-for-woocommerce' ),
	...
	add_settings_field(
		'somdn_link_class',
		__( 'Link classes', 'download-now-for-woocommerce' ),
	...
	add_settings_field(
		'somdn_link_css',
		__( 'Link CSS', 'download-now-for-woocommerce' ),
	...
	add_settings_field(
		...
		__( 'Show filename', 'download-now-for-woocommerce' ),
	...
	add_settings_field(
		...
		__( 'Force ZIP', 'download-now-for-woocommerce' ),
	...
	add_settings_field(
		...
		__( 'Checkbox error text', 'download-now-for-woocommerce' ),
	...
	add_settings_section(
		...
		__( 'Owned Products Settings', 'download-now-for-woocommerce' ),
	...
	add_settings_field(
		'somdn_owned_enable',
		__( 'Include Purchased Products', 'download-now-for-woocommerce' ),
	...
	if ( $somdn_owned_enabled ) :
		...
		add_settings_field(
			...
			__( 'Badge Text', 'download-now-for-woocommerce' ),
		...
		add_settings_field(
			...
			__( 'Hide Badge', 'download-now-for-woocommerce' ),
	...
	add_settings_section(
		...
		__( 'Debugging', 'download-now-for-woocommerce' ),
	...
	add_settings_field(
		...
		__( 'Debug Logging', 'download-now-for-woocommerce' ),
...
function somdn_debug_settings_section_callback() { ?>
	<p><?php _e( 'Settings related to plugin debugging.', 'download-now-for-woocommerce' ); ?></p>
<?php }
...
function somdn_owned_settings_section_callback() { 
	echo __( 'Customise the behaviour for products already purchased.', 'download-now-for-woocommerce' );
}
...
function somdn_owned_enable_render() {
	...
	<?php if ( ! $value ) { ?>
		<p class="description som-mar-bot-15"><?php _e( 'When enabled you will be able to customise this setting.', 'download-now-for-woocommerce' ); ?></p>
	<?php } ?>
 ...
 */
	if ( ! class_exists( 'ZipArchive' ) ) {
		...
		$message = __( 'Your server does not have ZipArchive installed, therefore zipping free downloads won\'t work.', 'download-now-for-woocommerce' );
